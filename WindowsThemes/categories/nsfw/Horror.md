...
> {: .opaque }
> {: .warning }
> ⚠️ These theme packs contain NSFW imagery and themes related to horror, violence, and supernatural elements that may be disturbing to some viewers. They are intended for mature audiences only. Viewer discretion is advised.
> 
