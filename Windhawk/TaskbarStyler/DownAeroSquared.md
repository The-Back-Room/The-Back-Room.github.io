...
```json
{
  ...
  "controlStyles[10].styles[6]": "Background@MultiWindowNormal:=$transparent",
  ...
  "controlStyles[15].styles[4]": "Background:=$transparent",
  "controlStyles[14].styles[4]": "Background:=$transparent",
