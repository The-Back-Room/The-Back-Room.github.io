...
```json
{
  ...
  "controlStyles[2].styles[0]": "CornerRadius=$radius",
  ...
  "controlStyles[4].styles[1]": "CornerRadius=$radius",
  ...
  "controlStyles[9].styles[0]": "Background@ActiveNormal:=$transparent",
  "controlStyles[9].styles[1]": "Background@ActivePressed:=$transparent",
  "controlStyles[9].styles[2]": "Background@ActivePointerOver:=$base",
  "controlStyles[9].styles[3]": "Background@InactiveNormal:=$transparent",
  "controlStyles[9].styles[4]": "Background@InactivePressed:=$transparent",
  "controlStyles[9].styles[5]": "Background@InactivePointerOver:=$base",
  "controlStyles[10].target": "Taskbar.TaskListLabeledButtonPanel@CommonStates > Border#BackgroundElement",
  "controlStyles[10].styles[0]": "Background@ActiveNormal:=$transparent",
  "controlStyles[10].styles[1]": "Background@ActivePressed:=$transparent",
  "controlStyles[10].styles[2]": "Background@ActivePointerOver:=$base",
  "controlStyles[10].styles[3]": "Background@InactiveNormal:=$transparent",
  "controlStyles[10].styles[4]": "Background@InactivePressed:=$transparent",
  "controlStyles[10].styles[5]": "Background@InactivePointerOver:=$base",
  "controlStyles[10].styles[6]": "Background@MultiWindowNormal:=$overlay",
  "controlStyles[10].styles[7]": "Background@MultiWindowPressed:=$transparent",
  "controlStyles[10].styles[8]": "Background@MultiWindowPointerOver:=$base",
  ...
  "controlStyles[13].styles[0]": "CornerRadius=$radius",
  "controlStyles[13].styles[1]": "BorderThickness=0",
  "controlStyles[13].styles[2]": "Foreground=White",
  "controlStyles[13].styles[3]": "Margin=3",
  "controlStyles[2].styles[3]": "Background:=$transparent",
  "controlStyles[13].styles[4]": "Background:=$transparent",
  "controlStyles[14].target": "Border#BackgroundElement",
  "controlStyles[15].target": "Border#MultiWindowElement",
  "controlStyles[14].styles[0]": "CornerRadius=$radius",
  ...
  "controlStyles[1].styles[2]": "Background:=$transparent",
  "controlStyles[16].target": "Windows.UI.Xaml.Controls.Grid#ModalRootGrid > Windows.UI.Xaml.Controls.Border#BackgroundElement",
  "controlStyles[16].styles[0]": "CornerRadius=$radius",
  "controlStyles[16].styles[1]": "Background:=$transparent",
  ...
  "controlStyles[9].styles[6]": "Background@MultiWindowNormal:=$transparent",
  "controlStyles[9].styles[7]": "Background@MultiWindowPressed:=$transparent",
  "theme": "",
  ...
  "controlStyles[9].styles[8]": "Background@MultiWindowointerOver:=$base",
  "controlStyles[3].styles[1]": "CornerRadius=$radius",
  "styleConstants[1]": "base=<AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" FallbackColor=\"{ThemeResource SystemAccentColor}\" TintOpacity=\"0.4\" TintLuminosityOpacity=\"0.4\" />",
  "styleConstants[2]": "transparent=<AcrylicBrush TintColor=\"Transparent\" FallbackColor=\"Transparent\" TintOpacity=\"0.1\" TintLuminosityOpacity=\"0.1\" />",
  "styleConstants[3]": "radius=2",
  "styleConstants[4]": "thickness=1",
  "styleConstants[5]": "font=Segoe UI",
  "controlStyles[9].styles[9]": "Margin=2",
  "controlStyles[15].styles[2]": "BorderThickness=0"
}
```