...
```json
{
  ...
  "controlStyles[41].styles[0]": "FontFamily=Franklin Gothic Medium",
  ...
  "controlStyles[34].styles[2]": "HorizontalAlignment=Left",
  ...
  "controlStyles[32].styles[4]": "Background:=$base",
  ...
  "controlStyles[55].styles[1]": "Background:=$overlay",
  "controlStyles[57].styles[3]": "BorderBrush:=$transparent",
  "controlStyles[66].styles[1]": "Background:=$overlay",
