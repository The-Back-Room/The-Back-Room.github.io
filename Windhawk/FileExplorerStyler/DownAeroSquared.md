...
```json
{
  ...
  "controlStyles[0].styles[0]": "Background@Normal:=$overlay",
  "controlStyles[0].styles[1]": "Background@PointerOver:=$overlay",
  "controlStyles[0].styles[2]": "Background@Pressed:=$overlay",
  "controlStyles[0].styles[3]": "Background@Disabled:=$alt",
  "controlStyles[0].styles[4]": "BorderBrush@Normal:=$transparent",
  "controlStyles[0].styles[5]": "BorderBrush@PointerOver:=$border",
  "controlStyles[0].styles[6]": "BorderBrush@Pressed:=$transparent",
  "controlStyles[0].styles[7]": "BorderBrush@Disabled:=$alt",
  "controlStyles[0].styles[8]": "CornerRadius=$radius",
  "controlStyles[0].styles[9]": "BorderThickness=$thickness",
  "controlStyles[1].target": "AppBarButton#forwardButton > Grid#Root@CommonStates > Border#AppBarButtonInnerBorder",
  "controlStyles[1].styles[0]": "Background@Normal:=$overlay",
  "controlStyles[1].styles[1]": "Background@PointerOver:=$overlay",
  "controlStyles[1].styles[2]": "Background@Pressed:=$overlay",
  "controlStyles[1].styles[3]": "Background@Disabled:=$alt",
  "controlStyles[1].styles[4]": "BorderBrush@Normal:=$transparent",
  "controlStyles[1].styles[5]": "BorderBrush@PointerOver:=$border",
  "controlStyles[1].styles[6]": "BorderBrush@Pressed:=$transparent",
  "controlStyles[1].styles[7]": "BorderBrush@Disabled:=$alt",
  "controlStyles[1].styles[8]": "CornerRadius=$radius",
  "controlStyles[1].styles[9]": "BorderThickness=$thickness",
  "controlStyles[2].target": "AppBarButton#refreshButton > Grid#Root@CommonStates > Border#AppBarButtonInnerBorder",
  "controlStyles[2].styles[0]": "Background@Normal:=$overlay",
  "controlStyles[2].styles[1]": "Background@PointerOver:=$overlay",
  "controlStyles[2].styles[2]": "Background@Pressed:=$overlay",
  "controlStyles[2].styles[3]": "Background@Disabled:=$alt",
  "controlStyles[2].styles[4]": "BorderBrush@Normal:=$transparent",
  "controlStyles[2].styles[5]": "BorderBrush@PointerOver:=$border",
  "controlStyles[2].styles[6]": "BorderBrush@Pressed:=$transparent",
  "controlStyles[2].styles[7]": "BorderBrush@Disabled:=$alt",
  "controlStyles[2].styles[8]": "CornerRadius=$radius",
  "controlStyles[2].styles[9]": "BorderThickness=$thickness",
  "controlStyles[3].styles[1]": "Background@PointerOver:=$overlay",
  "controlStyles[3].styles[2]": "Background@Pressed:=$overlay",
  "controlStyles[3].styles[3]": "Background@Disabled:=$border",
  "controlStyles[3].styles[4]": "BorderBrush@Normal:=$transparent",
  "controlStyles[3].styles[5]": "BorderBrush@PointerOver:=$border",
  "controlStyles[3].styles[6]": "BorderBrush@Pressed:=$transparent",
  "controlStyles[3].styles[7]": "BorderBrush@Disabled:=$border",
  "controlStyles[3].styles[8]": "CornerRadius=$radius",
  "controlStyles[3].styles[9]": "BorderThickness=$thickness",
  "controlStyles[3].target": "AppBarButton#upButton > Grid#Root@CommonStates > Border#AppBarButtonInnerBorder",
  "controlStyles[3].styles[0]": "Background@Normal:=$overlay",
  ...
  "controlStyles[13].styles[0]": "BorderBrush@Selected:=$transparent",
  "controlStyles[13].styles[1]": "BorderBrush@PointerOverSelected:=$border",
  "controlStyles[13].styles[2]": "BorderBrush@PressedSelected:=$transparent",
  "controlStyles[13].styles[3]": "BorderBrush@Normal:=$transparent",
  "controlStyles[13].styles[4]": "BorderBrush@PointerOver:=$border",
  ...
  "controlStyles[17].styles[0]": "BorderBrush:=$border",
  "controlStyles[17].styles[1]": "Background:=$overlay",
  "controlStyles[17].styles[2]": "Foreground=White",
  "controlStyles[17].styles[3]": "CornerRadius=$radius",
  "controlStyles[17].styles[4]": "BorderThickness=$thickness",
  ...
  "controlStyles[21].styles[2]": "CornerRadius=$radius",
  "controlStyles[21].styles[3]": "BorderThickness=$thickness",
