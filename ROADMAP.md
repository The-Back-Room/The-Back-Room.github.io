...
A list of website improvements planned for a future update.
...
### Icon Packs
A list of icon packs planned for a future update. This list is not in any particular order and may change at any time.

- **Gen2**: Lazer Red
- **Gen2**: Lady Pink
- **Gen2**: Antitoxin
- **Gen2**: Plasma Blue *(Complete)*
- **HUD**: Apocalypse *(Complete)*
- **HUD**: Evolution
- **HUD**: Launch
- **Steampunk**: Chrononaut
- **Floating Ice Chrononaut** *(Complete)*
- **Magnum Dark** *(Complete)*
- **Jarvis** *(Complete)*
- **Unity 2014** *(Complete)*
- **Unity 2016** *(Complete)*
- **Windows 7** *(Complete)*
- **Windows Vista** *(Complete)*
- **Windows XP** *(Complete)*

### Windows Themes
A list of Windows themes planned for a future update. This list is not in any particular order and may change at any time.
...
- **Deskthemepacks**:
    ...
    - **Game Inspired**:
        ...
        - **Final Fantasy XIV**:
            ...
            - **Final Fantasy XIV**: Stormblood *(Complete)*
    ...
    - **NSFW**:
        ...
        - **Final Fantasy XIV Waifus** *(Complete)*
        - **BLEACH**: Hentai *(Complete)*
        - **Sexy Naruto Girls** *(Complete)*