---
title: DownAero Squared  Alternate Start Menu Setup
summary: Instructions for setting up the DownAero Squared theme's Alternate Start Menu using Windhawk
nav_exclude: true
permalink: /Tutorials/WindhawkThemes/DownAeroSquared/AlternateStartMenu
---

## DownAero Squared Alternate Start Menu Setup
Instructions for setting up the DownAero Squared theme's Alternate Start Menu using Windhawk.
...
2. Download and install the [Windows 11 Start Menu Styler](https://windhawk.net/mods/windows-11-start-menu-styler) mod through Windhawk.
3. Copy and paste the code below into `Windhawk >> Windows 11 Start Menu Styler >> Advanced >> Mod Settings` and click `Save`:
