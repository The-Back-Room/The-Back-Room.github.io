...
1. **Start Menu**: Copy and paste the code below into `Windhawk >> Windows 11 Start Menu Styler >> Advanced >> Mod Settings` and click `Save`:
  ...
  ```json
  {
    ...
    "controlStyles[7].styles[1]": "Margin=-7",
    "controlStyles[7].styles[2]": "Height=38",
    "controlStyles[7].styles[3]": "Width=38",
    "controlStyles[7].styles[4]": "Background:=$card",
    "controlStyles[7].styles[5]": "BorderBrush@Normal:=$transparent",
    "controlStyles[8].target": "StartDocked.NavigationPaneButton#UserTileButton > Grid@CommonStates > Border#BackgroundBorder",
    ...
    "controlStyles[7].styles[6]": "BorderBrush@PointerOver:=$accentLight3",
    ...
    "controlStyles[32].target": "StartMenu.ExpandedFolderList > Grid > Grid > PipsPager#PinnedListPipsPager",
    "controlStyles[30].styles[0]": "CornerRadius=$n1",
    "controlStyles[30].styles[1]": "BorderThickness=$n2",
    "controlStyles[30].styles[2]": "Background:=$accent",
    ...
    "controlStyles[33].styles[0]": "Margin=0,-5,0,20",
    "controlStyles[34].target": "Border#AcrylicBorder",
    "controlStyles[34].styles[0]": "Background:=$accent",
    ...
    "controlStyles[39].target": "Windows.UI.Xaml.Controls.Primitives.ScrollBar#VerticalScrollBar",
    "controlStyles[39].styles[0]": "Visibility=1",
    "controlStyles[40].target": "StartDocked.StartMenuCompanion#RightCompanion > Grid#CompanionRoot > Grid",
    "controlStyles[41].target": "StartDocked.StartMenuCompanion#RightCompanion > Grid#CompanionRoot > Grid > Border#AcrylicBorder",
    "controlStyles[41].styles[0]": "Background:=Transparent",
    "controlStyles[42].target": "StartDocked.StartMenuCompanion#RightCompanion > Grid#CompanionRoot > Grid > Border#AcrylicOverlay",
    "controlStyles[42].styles[0]": "Background:=$card",
    "controlStyles[43].target": "Button#PrimaryActionBarButton > ContentPresenter@CommonStates",
    "controlStyles[43].styles[0]": "CornerRadius=$n1",
    "controlStyles[43].styles[1]": "BorderThickness=$n2",
    "controlStyles[43].styles[2]": "Background:=$card",
    "controlStyles[44].target": "Button#ActionBarOverflowButton > ContentPresenter@CommonStates",
    "controlStyles[44].styles[0]": "CornerRadius=$n1",
    "controlStyles[44].styles[1]": "Background:=$card",
    "controlStyles[44].styles[2]": "Height=40",
    "controlStyles[44].styles[3]": "Width=40",
    "controlStyles[43].styles[3]": "Height=40",
    "controlStyles[43].styles[4]": "Width=120",
    "controlStyles[44].styles[4]": "BorderBrush@Normal:=$transparent",
    "controlStyles[44].styles[5]": "BorderBrush@PointerOver:=$accentLight3",
    "controlStyles[44].styles[6]": "BorderBrush@Pressed:=$accentDark2",
    "controlStyles[44].styles[7]": "BorderThickness@Normal=$n2",
    "controlStyles[44].styles[8]": "BorderThickness@PointerOver=$n1",
    "controlStyles[44].styles[9]": "BorderThickness@Pressed=$n1",
    "controlStyles[43].styles[5]": "BorderBrush@Normal:=$transparent",
    "controlStyles[43].styles[6]": "BorderBrush@PointerOver:=$accentLight3",
    "controlStyles[43].styles[7]": "BorderBrush@Pressed:=$accentDark2",
    "controlStyles[43].styles[8]": "BorderThickness@Normal=$n2",
    "controlStyles[43].styles[9]": "BorderThickness@PointerOver=$n1",
    "controlStyles[43].styles[10]": "BorderThickness@Pressed=$n1",
    "controlStyles[7].styles[7]": "BorderBrush@Pressed:=$accentDark3",
    "controlStyles[7].styles[8]": "BorderThickness@Normal=$n2",
    "controlStyles[8].styles[3]": "BorderBrush@Normal:=$transparent",
    "controlStyles[8].styles[4]": "BorderBrush@PointerOver:=$accentLight3",
    "controlStyles[8].styles[5]": "BorderBrush@Pressed:=$accentDark3",
    "controlStyles[8].styles[6]": "BorderThickness@Normal=$n2",
    "controlStyles[8].styles[7]": "BorderThickness@PointerOver=$n1",
    "controlStyles[8].styles[8]": "BorderThickness@Pressed=$n1",
    "controlStyles[7].styles[9]": "BorderThickness@PointerOver=$n1",
    "controlStyles[7].styles[10]": "",
    "controlStyles[45].target": "Grid#ActionsBar",
    "controlStyles[45].styles[0]": "Background:=$accent",
    "controlStyles[45].styles[1]": "Margin=0,-20,0,0",
    "controlStyles[45].styles[2]": "Height=120",
    "controlStyles[40].styles[0]": "CornerRadius=$n1",
    "controlStyles[42].styles[1]": "BorderThickness=$n2",
    "controlStyles[45].styles[3]": "BorderThickness=$n2",
    "controlStyles[42].styles[2]": "BorderBrush:=$transparent",
    "controlStyles[45].styles[4]": "BorderBrush:=$transparent",
