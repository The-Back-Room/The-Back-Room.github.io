...
<div class="w3-card">
  <div class="w3-content w3-display-container" style="max-width:800px">
    ...
    <div align="center" class="w3-center w3-container w3-section w3-large w3-text-white w3-display-bottommiddle" style="width:100%">
      <p class="w3-left w3-hover-text-khaki" onclick="plusDivs(-1)">&#10094;</p><p class="w3-badge demo w3-border w3-transparent w3-hover-white" onclick="currentDiv(1)">&#9675;</p><p class="w3-badge demo w3-border w3-transparent w3-hover-white" onclick="currentDiv(2)">&#9675;</p><p class="w3-right w3-hover-text-khaki" onclick="plusDivs(1)">&#10095;</p>
    </div>
  </div>
