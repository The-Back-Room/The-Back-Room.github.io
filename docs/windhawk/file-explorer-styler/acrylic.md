...
```json
{
  ...
  "controlStyles[1].styles[0]": "Background@Normal := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" Opacity=\"0.05\"/>",
  "controlStyles[1].styles[1]": "Background@PointerOver := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" Opacity=\"0.12\"/>",
  "controlStyles[1].styles[2]": "Background@Pressed := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" Opacity=\"0.12\"/>",
  "controlStyles[1].styles[3]": "Background@Disabled := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" Opacity=\"0.05\"/>",
  ...
  "controlStyles[5].styles[1]": "BorderBrush = <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColor}\" Opacity=\"0.5\" />",
  "controlStyles[5].styles[2]": "ConrerRadius = 2",
  ...
  "controlStyles[15].styles[0]": "Background@Selected := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark1}\" Opacity=\"0.35\" />",
  "controlStyles[15].styles[1]": "Background@PointerOverSelected := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark1}\" Opacity=\"0.35\" />",
  "controlStyles[15].styles[2]": "Background@PointerOver := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark2}\" Opacity=\"0.13\" />",
  "controlStyles[15].styles[3]": "Background@Normal := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark3}\" Opacity=\"0.05\" />",
  "controlStyles[15].styles[4]": "Background@PressedSelected := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark1}\" Opacity=\"0.35\" />",
  ...
  "controlStyles[23].styles[3]": "BorderBrush := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorLight1}\" Opacity=\"0.3\" />",
  "controlStyles[23].styles[4]": "Background := <AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorDark1}\" Opacity=\"0.3\" />",
