...
<img src="/assets/images/social-images/windows-themes/cover-cartoon-themes.png" alt="Windows Themes" width="100%" height="auto" />
...
<h3 class="text-gamma">Courage the Cowardly Dog</h3>
<!-- A theme for Windows 10 and 11 inspired by the popular animated series Courage the Cowardly Dog.<br /><br /> -->
