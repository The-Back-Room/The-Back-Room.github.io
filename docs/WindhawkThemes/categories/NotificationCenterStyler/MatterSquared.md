...
```json
{
  ...
  "controlStyles[29].styles[0]": "CornerRadius=2",
  "controlStyles[28].styles[0]": "CornerRadius=2",
  "controlStyles[27].styles[0]": "CornerRadius=2",
  "controlStyles[26].styles[0]": "CornerRadius=2",
  "controlStyles[25].styles[0]": "CornerRadius=2",
  "controlStyles[30].target": "CalendarViewDayItem > Border",
  "controlStyles[30].styles[0]": "CornerRadius=2",
  ...
  "controlStyles[32].styles[0]": "CornerRadius=2",
  "controlStyles[33].target": "Primitives.CalendarViewItem",
  "controlStyles[33].styles[0]": "CornerRadius=2",
  ...
  "controlStyles[37].styles[0]": "CornerRadius=2",
  "controlStyles[34].styles[0]": "CornerRadius=2",
  "controlStyles[38].target": "ListViewItem",
  "controlStyles[38].styles[0]": "CornerRadius=2",
  "controlStyles[39].target": "Grid#RootGrid > ContentPresenter#ContentPresenter",
  "controlStyles[39].styles[0]": "CornerRadius=2",
  "controlStyles[40].target": "Grid > Border#ItemOpaquePlating",
  "controlStyles[41].target": "Grid#StandardHeroContainer",
  "controlStyles[40].styles[0]": "CornerRadius=2",
  "controlStyles[41].styles[0]": "CornerRadius=2",
  "controlStyles[36].styles[0]": "CornerRadius=2",
  "controlStyles[35].styles[0]": "CornerRadius=2",
  "controlStyles[23].styles[0]": "RadiusY=2",
  "controlStyles[23].styles[1]": "RadiusX=2",
  "controlStyles[24].styles[0]": "RadiusY=2",
  "controlStyles[24].styles[1]": "RadiusX=2",
  "controlStyles[42].target": "Button#BackButton",
  "controlStyles[42].styles[0]": "CornerRadius=2",
  "controlStyles[43].target": "Windows.UI.Xaml.Shapes.Rectangle#OuterBorder",
  "controlStyles[43].styles[0]": "RadiusX=2",
  "controlStyles[43].styles[1]": "RadiusY=2",
  "controlStyles[44].target": "Windows.UI.Xaml.Shapes.Rectangle#SwitchKnobOff",
  "controlStyles[44].styles[0]": "RadiusY=2",
  "controlStyles[44].styles[1]": "RadiusX=2",
  ...
  "controlStyles[46].styles[0]": "RadiusX=2",
  "controlStyles[46].styles[1]": "RadiusY=2",
